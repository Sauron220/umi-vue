<template>
  <div class="product-detail product-parent-child" v-TDK="TDK">
    <div class="container">
            ...
            <form action="" method="post" id="payForm" submit="investRule" novalidate="">
              <div class="balance clearfix">
                ...
                <div class="account-info" v-if="userInfo.loginResult">
                  ...
                  <a class="charge pull-right" href="javascript:;" @click="showOpenFloat();">儲值</a>
                </div>
                <div class="account-info" v-if="!userInfo.loginResult">
              ...
              <div class="amount-money">
                ...
                <i class="p-error" v-if="errors.first('invest') && userInfo.loginResult && productDetail.status != 12">{{errors.first('invest')}}</i>
              </div>
    ...
    <div class="section-space"></div>
    <div class="container">
      <div class="content-intro-top"></div>
      <div class="content-intro planning-period">
        <div class="title">
      ...
      <div class="content-intro section-space"></div>
      <ul id="tab" class="list-inline tab clearfix content-intro">
        <li :class="{'active':tabAt == 1}" @click="setTabValue(1)">產品介紹</li>
        <li :class="{'active':tabAt == 2}" @click="setTabValue(2)">出借記錄</li>
      </ul>
      <div class="content-intro section-space"></div>
      <div class="content-intro detail-intro" v-if="tabAt==1">
        <div class="check">
          <div class="title">
      ...
      <div class="content-intro record" v-if="tabAt==2">
        <div class="tit">
      ...
      <div class="content-intro-bottom"></div>
    </div>
    <br>
    <br>
    <br>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-body form-horizontal">
          ...
          <a class="btn btn-warning btn-block btn-lg submit" target="_blank"
             @click="buyHandle('/parent-child-detail/'+productDetail.prdCode+'/'+$route.params.investMoney);"
  ...
  export default {
    ...
    created() {
      ...
      self.getProductDetail(this.$route.params.prdCode, function () {
        ...
        if (self.$route.params.investMoney && self.$route.params.investMoney != 0) {
