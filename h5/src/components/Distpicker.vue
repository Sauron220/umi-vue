    ...
    <div :class="wrapper">
        <template v-if="type != 'mobile'">
            ...
            <template v-if="!onlyProvince">
                <select @change="getAreas" v-model="currentCity" class="select-line">
...
<script>
  ...
  export default {
    ...
    props: {
      ...
      hideArea: { type: Boolean, default: true },
    ...
    methods: {
      emit(name) {
        ...
        if (!this.onlyProvince) {
          this.$set(data, 'city', {
            code: this.getCityCode(this.currentCity),
