<template>
    <div class="wrap product-content">
        ...
        <div class="contScroll mui-content">
            <div class="product-top">
                <div>
                    ...
                    <div id="countdown">
                        <div id="tiles" class="residual-time"
                             v-if="productDetail.status == 11">剩余时间
                ...
                <img src="../assets/images/long_logo.jpg" class="long-logo">
            </div>
            <div class="cycle">
                <h1>计划周期</h1>
            ...
            <div class="about">
                ...
                <div>
                    <h3>产品详情</h3>
                    <span @click="openDetail" class="more bid-range text-blue">查看详情</span>
                </div>
            </div>
            <div class="space"></div>
        </div>
        <div class="look-details" :class="{'look-details-high': watchDetail == true}">
            <div class="pull-box">
                ...
                <div class="details details1" v-if="tabAt==1">
                    ...
                    <h2 class="dd2 audit-data" v-if="productDetail.verifyInfo">审核资料</h2>
                    <div class="photo-views" v-if="productDetail.verifyInfo">
                        <img src="../assets/images/look_details1_tip.png" class="right-icon">
                        <see-box class="audit-data">
        ...
        <div class="bottom-btn">
            <a v-if="productDetail.status == 11 && showLeftTime != 0" class="product-btn product-btn-high"
            ...
            <a v-if="productDetail.status == 12 && showBeginTime != 0" class="product-btn product-btn-high"
            ...
            <div class="pos">
                ...
                <div class="bar bar-white">
                    <div class="six-box clearfix">
                        ...
                        <input class="inp" type="text" name="invest" maxlength="10" v-model="invest"
                               ...
                               moreThan:productDetail.remainAmount}}" v-if="productDetail.remainAmount<productDetail.minInvAmt">
                        <input class="inp" type="text" name="invest" maxlength="10" v-model="invest"
                               :placeholder="inputPlaceholder" v-validate="{rules:{required:true,
                               investRule:[productDetail.maxInvAmt,productDetail.remainAmount,accountInfo.balanceAmount],
                ...
                <div class="bar bar-gray alert">
                    ...
                    <div id="base-alert" v-else>
                        ...
                        2、关注微信公众号 <i class="text-blue">“上海聚寶盆”</i> 留言提问
                    </div>
                </div>
            </div>
  ...
  export default {
    ...
    created(){
      ...
      self.getProductDetail(this.$route.params.prdCode, function () {
        ...
        document.querySelector('.previous-record').setAttribute('href', '/product-list/'+self.productDetail.prdType+'/1');

        var prevInd = document.referrer.substring(document.referrer.lastIndexOf('/'))
        if(self.$route.query.asset == '1'){
