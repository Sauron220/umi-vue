  ...
  <div class="myassets-new">
        ...
        <div class="draw-ri">
          ...
          <div class="tit-hed" v-for="(item, index) in proMonthList" :key="index">
            <div class="tit-desc"
                 ...
                 'tit-he-tic': item.prdType == 8, 'tit-he-tif': item.prdType == 9, 'tit-he-tib': item.prdType == '-'}">{{ item.prdType| proName}}
            </div>
    ...
    <div class="total-product">
      <div class="product-list-nav">
        <div class="nav-item" @click="toNextPage(1, '70')" :class="{'active-item': flag == 1}">壹桶金</div>
        ...
        <!--<div class="nav-item" @click="toNextPage(5, '-')" :class="{'active-item': flag == 4}">散標</div>-->
      </div>
    </div>
