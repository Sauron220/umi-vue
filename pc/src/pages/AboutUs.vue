<template>
  <div class="hello aboutUs-content" v-TDK="TDK">
    ...
    <!--<div class="special-cont">
      ...
      <p>
        “聚寶盆”平臺是由尤鹿資訊傾力打造的互聯網金融交易平臺。其核心交易系統標準搭建參照銀行，為立體帳戶系統，對客戶而言意味著系統更安全穩定，體驗更順暢，每筆交易可追溯；對監管而言，真正做到資產存續和資金流向的清晰透明，從系統及業務上均擁抱監管要求。系統本身強調低藕合，高內聚；可拆分，易配置；可根據不同產品特性及托管要求快速叠代，為不同客戶提供多維度的資產配置建議及資訊展示。
      </p>
      <br>
      <p>
