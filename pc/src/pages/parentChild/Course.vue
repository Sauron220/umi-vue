<template>
  <div class="parent-child" v-TDK="TDK" :class="{'female':childInfo.chlSex==0 || !childInfo.chlSex}">
    ...
    <div class="container">
      <div class="section-box section-activity">
        <div class="title text-center">
          <img src="../../assets/images/parent-child/classroom-title.png" alt="title">
        </div>
...
<script>
  ...
  export default {
    ...
    created(){
      var self = this;
      // 親子活動
      self.$http.post('/pbap-web/action/news/query/newsList?course', {
        "pageSize": 8,
